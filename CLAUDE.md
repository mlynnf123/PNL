...
Next (Phase H remainder, deferred earlier): job documents + supplements-via-revenue_components. Then estimate-engine EP-2+ (inspection/custom pages, legal doc-kind, remote signing).
