...
export default async function RolesSettingsPage() {
  ...
  if (!canManage) {
    return (
      <div className="flex flex-1 flex-col gap-4">
        <h2 className="text-lg font-normal tracking-[0.035em] text-slate-900">Roles</h2>
        <NoAccessNotice />
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-1 flex-col gap-6">
      <h2 className="text-lg font-normal tracking-[0.035em] text-slate-900">Roles &amp; permissions</h2>
